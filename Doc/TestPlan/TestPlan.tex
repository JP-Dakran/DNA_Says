...
\section{Plan}
\par This section provides information about the plan for testing. It includes descriptions of software, testing members as well as other details on tools and automation for testing. Provided at the end is a link to testing schedule on the Gantt chart.
\textcolor{red}{Provide link to subsection - CM} \\
...
\textcolor{red}{Don't rely on table - CM} \\
.
\begin{table}[h]
...
\textcolor{red}{Use "here" instead of "following url:" - CM} \\
...
\item Execution: User presses buttons on menu and again in mode selected to follow pattern, satisfaction regarding button appearance is recorded by the user.
\end{itemize}
...
\item Execution: User tries to follow visual/audio pattern shown, and observes sounds made by buttons pressed. Patterns to follow should have notes associated with them them compose a song or a little rhyme. User satisfaction with sounds is recorded.
\end{itemize}
\end{itemize}
...
\item Execution: User plugs in USB to transfer game from the USB key to their system, game is transferred with ease. User review is then recorded.
\end{itemize}
...
\item Execution: User starts playing the game and following patterns shown, instructions will be provided on every page.
\end{itemize}
...
A set of unit tests will be performed on functions used in the implementation of the system. This testing is to ensure that changes to the game do not break the basic functioning of the game. Test cases that will be used are outlined below.
