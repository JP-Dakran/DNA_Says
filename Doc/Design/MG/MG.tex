...
& M2\\
& M4 \textcolor{red}{Aren't 4,5,6 all referenced in your SRS? Having 3 modes? - CM}\\
& M5\\
& M6\\
& M12\\
& M13\\
...
\begin{description}
\item[Secrets:]Structure to display title, instructions, buttons. \textcolor{red}{Feel free to be general as UI elements can and should change as the design goes on. Move details to services in which titles, buttons and such will be implicitly required to satisfy - CM}
...
\begin{description}
\item[Secrets:]The structure of the refreshing of the display. \textcolor{red}{Reword, there is not structure to refresh a display - CM} \\
...
\begin{description}
\item[Secrets:]The format of the instructions. \textcolor{red}{Not all these need to formats and structures - CM}
...
\textcolor{red}{What is the middle, unnamed module?! - CM} \\
\textcolor{red}{From kareem to menu for example, you don't need to two lines. The menu uses kareem in a stack like structure. It places the kareem page on the stack, and removes it. Don't make these loops. What it tells me is that menu needs kareem to work, and kareem needs menu to work, which doesn't make sense. - CM} \\
\begin{figure}[H]
\centering
